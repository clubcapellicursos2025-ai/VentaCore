...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/brands", label: "Marcas", icon: Tag, badge: null },
    ...
    { href: "/reports", label: "Reportes Avanzados", icon: FileText, badge: "Nuevo", badgeColor: "bg-cyan-500/20 text-cyan-400 border-cyan-500/30" },
